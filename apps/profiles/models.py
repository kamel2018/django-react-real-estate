...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"),max_length=30, default="+3388888888")
    about_me=models.TextField(verbose_name=_("About me"),default="Say something about yourself")
    licence=models.CharField(verbose_name=_("Real estate licence"),
                             max_length=20, blank=True, null=True)
    profile_phot=models.ImageField(verbose_name=_("Profile Photo"),default="/profile_default.png")
    ...
    city=models.CharField(verbose_name=_("City"),max_length=180, default="Paris",blank=False,null=False)
    is_buyer=models.BooleanField(verbose_name=_("Buyer"),default=False,
                                 help_text=_("Are you looking to buy a Property ?"))
    is_seller = models.BooleanField(verbose_name=_("Seller"),default=False, help_text=_("Are you going to sell a Property ?"))
